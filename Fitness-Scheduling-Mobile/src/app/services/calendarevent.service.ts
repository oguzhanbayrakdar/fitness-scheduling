import { CalendarEvent, CellStyle, CalendarFontStyle, DayCellStyle, CalendarMonthViewStyle, CalendarSelectionShape, CalendarWeekViewStyle, CalendarCellAlignment, CalendarYearViewStyle, MonthCellStyle, CalendarDayViewStyle, DayEventsViewStyle, AllDayEventsViewStyle, CalendarMonthNamesViewStyle } from "nativescript-ui-calendar";
...
export class CalendarEventsService {
    ...
    getCalEvent(): Array<CalendarEvent> {
        let now = new Date();
        let startDate: Date,
            endDate: Date,
            counter: number=0,
        ...
        for (var i = 1; i <= 100; i++) {
            ...
            event = new CalendarEvent(
                ...
                false,
                new Color(255, rnd * 5 + 5, 255- (rnd * 5), 0)
            );
            events.push(event);
        }
    ...
    getMonthViewStyle(): CalendarMonthViewStyle {
        ...
        monthViewStyle.backgroundColor = this._brightBlueColor;
